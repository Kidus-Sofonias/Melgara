...
export const ORES = [
  {
    ...
    // 3D realism profile (Cryo Copper — glowing copper-gold + teal
    // patina so the crystals pop against the ink-blue night)
    color: "#e8903c",
    veinColor: "#ffc26b",
    patina: "#58d3c8",
    roughness: 0.3,
  ...
  },
  {
    ...
    photoCredit: "Chrome ore specimen — Melgara Mining",
  ...
  },
  {
    ...
    photoCredit: "Gypsum specimen — Melgara Mining",
